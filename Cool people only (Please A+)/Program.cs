...
void AssignBoardingGateToFlight(Terminal terminal)
{
    while (true)
    {
        ...
        try
        {
            Console.WriteLine("Please enter your flight number (e.g. TR 788):");
            string? flightNum = Console.ReadLine();
            ...
            {
                tempFlight = terminal.Flights[flightNum];
                foundFlight = true;
            }
            ...
            if (foundFlight)
            {
                while (true)
                {
                    ...
                    {
                        tempGate = terminal.BoardingGates[gateName];
                        foundGate = true;
                    }
                    else
                    {
        ...
        {
            Console.WriteLine("Please ensure that the flight number follows the format (e.g. TR 788)");
        }
    }
}
